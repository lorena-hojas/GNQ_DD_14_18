...
####################################################################################
shp <- readOGR(paste0(seg_dir,"continenteSEPAL5-80-11.shp"))
dbf <- shp@data
tif <- raster(paste0(edd_dir,"uni_map_dd_continente_aea_20171206.tif"))
...
writeOGR(shp,paste0(seg_dir,"seg_continente.shp"),paste0(seg_dir,"seg_continente"),"ESRI Shapefile",overwrite_layer = T)

system(sprintf("python %s/oft-rasterize_attr_32.py -v %s -i %s -o %s -a %s",
               scriptdir,
               paste0(seg_dir,"seg_continente.shp"),
               paste0(edd_dir,"uni_map_dd_continente_aea_20171206.tif"),
               paste0(seg_dir,"seg_continente.tif"),
               "DN"
))
...
mask   <- paste0(edd_dir,"uni_map_dd_continente_aea_20171206.tif")
...
#################### FOREST NON FOReST DEGRADATION FOR 2014-2014
system(sprintf("gdal_calc.py -A %s --co COMPRESS=LZW --outfile=%s --calc=\"%s\"",
               paste0(edd_dir,"uni_map_dd_continente_aea_20171206.tif"),
               paste0(edd_dir,"bnb_2014_continente.tif"),
...
system(sprintf("gdal_calc.py -A %s --co COMPRESS=LZW --outfile=%s --calc=\"%s\"",
               ...
               paste0(gfc_dir,"pnp_aea_continente.tif"),
               paste0("(A<14)*0+(A>=14)*(A<=18)*1")
))

##########################################################################################
#### Compute stats de mapa dd 2014_2014
system(sprintf("oft-his -i %s -o %s -um %s -maxval %s",
               paste0(edd_dir,"bnb_2014_continente.tif"),
               paste0(rootdir,"stat_mapa_dd_2014_2014_continente.txt"),
               paste0(seg_dir,"seg_continente.tif"),
               3
))
...
system(sprintf("oft-his -i %s -o %s -um %s -maxval %s",
               paste0(gfc_dir,"pnp_aea_continente.tif"),
               paste0(rootdir,"stat_perdidas_gfc_2014_2018_continente.txt"),
               paste0(seg_dir,"seg_continente.tif"),
               1
))
...
df_perdidas <- read.table(paste0(rootdir,"stat_perdidas_gfc_2014_2018_continente.txt"))
df_mapadd   <- read.table(paste0(rootdir,"stat_mapa_dd_2014_2014_continente.txt"))
...
system(sprintf("(echo %s; echo 1; echo 1; echo 9; echo 0) | oft-reclass  -oi %s  -um %s %s",
               ...
               paste0(tmp_dir,"tmp_continente_mapa_2014_2018.tif"),
               paste0(seg_dir,"seg_continente.tif"),
               paste0(seg_dir,"seg_continente.tif")
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(tmp_dir,"tmp_continente_mapa_2014_2018.tif"),
               paste0(tmp_dir,"tmp_byte_continente_mapa_2014_2018.tif")
))
...
system(sprintf("(echo %s) | oft-addpct.py %s %s",
               ...
               paste0(tmp_dir,"tmp_byte_continente_mapa_2014_2018.tif"),
               paste0(tmp_dir,"tmp_pct_continente_mapa_2014_2018.tif")
))
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(tmp_dir,"tmp_pct_continente_mapa_2014_2018.tif"),
               paste0(map_dir,"continente_mapa_2014_2018.tif")
))
